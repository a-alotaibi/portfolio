...
export class ContactComponent {
  ...
  protected channels: Channel[] = [
    ...
    {
      ar: { label: 'GitHub', sub: '/abdulaziz' },
      en: { label: 'GitHub', sub: '/abdulaziz' },
      href: 'https://github.com/abdulaziz',
      gradient: 'linear-gradient(135deg, #14142b, #4a4a6a)',
      iconPath: 'M12 0a12 12 0 0 0-3.79 23.4c.6.1.82-.26.82-.58v-2.05c-3.34.72-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.74.08-.73.08-.73 1.2.08 1.84 1.24 1.84 1.24 1.07 1.83 2.81 1.3 3.5.99.1-.78.42-1.3.76-1.6-2.67-.31-5.47-1.34-5.47-5.95 0-1.31.47-2.39 1.24-3.23-.13-.3-.54-1.52.11-3.18 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 0 1 6 0c2.29-1.55 3.3-1.23 3.3-1.23.65 1.66.24 2.88.12 3.18.77.84 1.23 1.92 1.23 3.23 0 4.62-2.81 5.63-5.49 5.93.43.37.81 1.1.81 2.22v3.29c0 .32.21.7.83.58A12 12 0 0 0 12 0z'
    },
    {
      ar: { label: 'تويتر / X', sub: '@abdulaziz' },
      en: { label: 'Twitter / X', sub: '@abdulaziz' },
      href: 'https://x.com/abdulaziz',
      gradient: 'linear-gradient(135deg, #14142b, #7b5cff)',
    ...
    {
      ar: { label: 'تيليجرام', sub: '@abdulaziz' },
      en: { label: 'Telegram', sub: '@abdulaziz' },
      href: 'https://t.me/abdulaziz',
      gradient: 'linear-gradient(135deg, #00d4ff, #2ee6a8)',
      iconPath: 'M21.94 4.4 18.66 19.9c-.25 1.1-.9 1.36-1.83.85l-5.05-3.72-2.44 2.34c-.27.27-.5.5-1.02.5l.36-5.13 9.34-8.44c.4-.36-.09-.56-.62-.2L5.86 13.4 1.13 11.92c-1.02-.32-1.05-1.02.22-1.51l18.4-7.1c.85-.31 1.6.21 1.34 1.32.95-.08 1.94-.06 0 0z'
    }
  ];
}
