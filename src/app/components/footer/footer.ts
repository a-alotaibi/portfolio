...
export class FooterComponent {
  ...
  protected socials: SocialLink[] = [
    { label: 'GitHub',   href: 'https://github.com/abdulaziz',
    ...
    { label: 'Telegram', href: 'https://t.me/abdulaziz',
      iconPath: 'M21.94 4.4 18.66 19.9c-.25 1.1-.9 1.36-1.83.85l-5.05-3.72-2.44 2.34c-.27.27-.5.5-1.02.5l.36-5.13 9.34-8.44c.4-.36-.09-.56-.62-.2L5.86 13.4 1.13 11.92c-1.02-.32-1.05-1.02.22-1.51l18.4-7.1c.85-.31 1.6.21 1.34 1.32z' }
  ];
}
